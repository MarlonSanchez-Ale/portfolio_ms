...
/*
 ...
 <section className=" py-32 bg-white sm:px-10">
            <div className="flex flex-col justify-center gap-10 text-center">
                ...
                <div className="group inline-flex flex-wrap justify-center gap-10">
                    <span className="cursor-pointer rounded-full border border-gray-900/5 bg-gray-200/5 p-3 text-gray-900 transition-colors hover:border-gray-900/10 hover:bg-gray-900/10 hover:!opacity-100 group-hover:opacity-70">
                        <BsEnvelope size={20} color="orange" />
                    </span>
                    <span className="cursor-pointer rounded-full border border-gray-900/5 bg-gray-200/5 p-3 text-gray-900 transition-colors hover:border-gray-900/10 hover:bg-gray-900/10 hover:!opacity-100 group-hover:opacity-70">
                        <BsTelephone size={20} color="orange" />
                    </span>
                    <span className="cursor-pointer rounded-full border border-gray-900/5 bg-gray-200/5 p-3 text-gray-900 transition-colors hover:border-gray-900/10 hover:bg-gray-900/10 hover:!opacity-100 group-hover:opacity-70">
                        <ImInstagram size={20} color="orange" />
                    </span>
